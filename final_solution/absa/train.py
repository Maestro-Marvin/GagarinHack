...
class TransformerClassificationTrainer:
    ...
    def train(self, train_texts, train_aspects, train_labels, device):
        train_inputs, train_labels = self.preprocess_data(
    ...
    def evaluate(self, test_texts, test_aspects, test_labels, device):
        self.model.eval()
        test_inputs, test_labels = self.preprocess_data(
